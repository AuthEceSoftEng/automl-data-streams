...
if __name__ == "__main__":
    seed = 30
    # create dataset
    data = create_loandataset(4, datalimit=20000,
    ...
    result_extractor(3, 1, y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp)
    ...
    result_extractor(3, 2, y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp)
    ...
    result_extractor(3, 3, y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp)
    ...
    result_extractor(3, 4, y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp)
    ...
    result_extractor(3, 5, y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp)
    ...
    result_extractor(3, 6, y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp)
    ...
    result_extractor(3, 7, y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp)
    ...
    result_extractor(3, 8, y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp)
    ...
    result_extractor(3, 9, y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp)
