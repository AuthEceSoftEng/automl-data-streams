...
if __name__ == "__main__":
    ...
    data = prepare_data('../More_datasets/Hyperplane.csv')
    ...
    result_extractor(7, 1, y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp)
    ...
    result_extractor(7, 2, y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp)
