...
if __name__ == "__main__":
    ...
    result_extractor(6, 1, y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp)
    ...
    result_extractor(6, 2, y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp)
