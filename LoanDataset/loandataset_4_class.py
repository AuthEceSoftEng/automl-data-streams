...
"""
    ...
    0 means no loan is given except from some exceptions
    1 means no loan is given except some special co
    2 means loan is given under conditions
    3 means loan is given 
"""
...
class LoanDataset(datasets.base.SyntheticDataset):
    ...
    * `loan` | total loan amount | uniformly distributed from 10000 to 10000 x 0.85 x housevalue
    ...
    def __init__(self, seed: int | None = None):
        super().__init__(n_features=8, n_classes=4, n_outputs=1, task=datasets.base.MULTI_CLF)
