...
import numpy as np
import pandas as pd
from river import metrics, preprocessing, tree, forest, linear_model, datasets
...
if __name__ == "__main__":
    seed = 30
    experiment_no = "rialto"

    # Load dataset
    # open the csv with data
    df = pd.read_csv('../More_datasets/rialto.data',delimiter=" ")
    df2 = pd.read_csv('../More_datasets/rialto.labels',delimiter=" ")

    # ad the target to the dataframe
    df["28"] = df2["28"]
