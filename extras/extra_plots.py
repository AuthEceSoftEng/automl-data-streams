...
for experiment_no in ('covtype', 'rialto'):
    if not os.path.exists('data' + str(experiment_no) + '.pkl'):
        ...
        y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp = take_saved_data(
            f"experiment{experiment_no}_pipeline1_results.csv")
        ...
        y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp = take_saved_data(
            f"experiment{experiment_no}_pipeline2_results.csv")
        # add the results from the pipeline in the lists
        y_real.append(y_real_temp)
        y_predicted.append(y_predicted_temp)
        data_drifts.append(data_drifts_temp)
        ...
        y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp = take_saved_data(
            f"experiment{experiment_no}_pipeline3_results.csv")
        # add the results from the pipeline in the lists
        y_real.append(y_real_temp)
        y_predicted.append(y_predicted_temp)
        data_drifts.append(data_drifts_temp)
        ...
        y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp = take_saved_data(
            f"experiment{experiment_no}_pipeline4_results.csv")
        # add the results from the pipeline in the lists
        y_real.append(y_real_temp)
        y_predicted.append(y_predicted_temp)
        data_drifts.append(data_drifts_temp)
        ...
        y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp = take_saved_data(
            f"experiment{experiment_no}_pipeline5_results.csv")
        # add the results from the pipeline in the lists
        y_real.append(y_real_temp)
        y_predicted.append(y_predicted_temp)
        data_drifts.append(data_drifts_temp)
        ...
        y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp = take_saved_data(
            f"experiment{experiment_no}_pipeline6_results.csv")
        # add the results from the pipeline in the lists
        y_real.append(y_real_temp)
        y_predicted.append(y_predicted_temp)
        data_drifts.append(data_drifts_temp)
        ...
        y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp = take_saved_data(
            f"experiment{experiment_no}_pipeline7_results.csv")
        # add the results from the pipeline in the lists
        y_real.append(y_real_temp)
        y_predicted.append(y_predicted_temp)
        data_drifts.append(data_drifts_temp)
        ...
        y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp = take_saved_data(
            f"experiment{experiment_no}_pipeline8_results.csv")
        # add the results from the pipeline in the lists
        y_real.append(y_real_temp)
        y_predicted.append(y_predicted_temp)
        data_drifts.append(data_drifts_temp)
        ...
        y_real_temp, y_predicted_temp, data_drifts_temp, concept_drifts_temp = take_saved_data(
            f"experiment{experiment_no}_pipeline9_results.csv")
        # add the results from the pipeline in the lists
...
for experiment_no in ('covtype', 'rialto'):
    ...
    linestyles = ['dotted', 'dashed', 'dashdot', (5, (10, 3)), (0, (3, 1, 1, 1)), (0, (5, 1)), (0, (3, 1, 1, 1, 1, 1)),
                  (0, (5, 5)), 'solid']  #
